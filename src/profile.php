...
$sql_appointments = "SELECT * FROM appointments WHERE user_id = ?";
$stmt_appt = $conn->prepare($sql_appointments);
$stmt_appt->bind_param("i", $user_id);
$stmt_appt->execute();
$appointments_result = $stmt_appt->get_result();
...
<head>
    ...
    <title>Profile - Mira Atelier</title>
    <link rel="stylesheet" href="css/profile.css">
</head>
<body>
<header>
        <h1>Mira Atelier - Profile</h1>
        <nav>
